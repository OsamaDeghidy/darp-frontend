...
const ReportTrackStatus: FC<IProps> = (props) => {
	const t = useI18n();
	const schema = () => {
					...
					<Form>
						<div className="grid grid-cols-12 gap-[24px] mb-[20px]">
							...
							<Field
								...
								label={t('feedbackSuggestionsOnThePath')}
								placeholder={t('pleaseWriteYour', {
									fieldName: t(
										'feedbackSuggestionsOnThePath',
									),
								})}
								name={'feedbackSuggestionsOnThePath'}
...
export default ReportTrackStatus;
