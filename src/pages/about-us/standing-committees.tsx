...
return (
		<AboutUsLayout
			...
			breadcrumb={[
				...
				{
					title: t('standingCommittees'),
				},
			]}
		>
			<StandingCommittees data={pageProps.data} />
		</AboutUsLayout>
	);
};
