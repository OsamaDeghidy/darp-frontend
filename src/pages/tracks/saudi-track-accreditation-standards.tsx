...
const SaudiTrackAccreditationStandardsPage: NextPage = ({
															pageProps,
...
export const getServerSideProps: GetServerSideProps = withEveryone(
	wrapper.getServerSideProps((store) => async (context) => {
		...
		const trackStandards = await store.dispatch(
...
export default SaudiTrackAccreditationStandardsPage;
